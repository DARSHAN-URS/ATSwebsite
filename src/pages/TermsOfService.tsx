      ...
      <main className="max-w-7xl mx-auto px-8 pt-48 pb-40 space-y-20">
        ...
        <div className="space-y-20 text-lg leading-relaxed max-w-4xl mx-auto">
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s1Title}</h2>
             <p className="font-medium text-slate-600">{tt.s1Content}</p>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s2Title}</h2>
             <p className="font-medium text-slate-600">{tt.s2Content}</p>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s3Title}</h2>
             <ul className="list-disc pl-8 space-y-4 font-medium text-slate-600">
                {tt.s3Items.map((item, i) => <li key={i}>{item}</li>)}
             </ul>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s4Title}</h2>
             <p className="font-medium text-slate-600">{tt.s4Content}</p>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s5Title}</h2>
             <p className="font-medium text-slate-600">{tt.s5Content}</p>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s6Title}</h2>
             <p className="font-medium text-slate-600">{tt.s6Content}</p>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s7Title}</h2>
             <p className="font-medium text-slate-600">{tt.s7Content}</p>
          </section>
          <section className="space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s8Title}</h2>
          ...
          <section className="p-16 rounded-[3.5rem] bg-slate-50 border border-slate-100 space-y-6">
             <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{tt.s9Title}</h2>
