        ...
        <div className="mx-auto max-w-7xl px-5 md:px-6 py-10 md:py-14">
          <div className="grid gap-8 md:gap-10 md:grid-cols-12">
            <div className="md:col-span-5 text-center md:text-left">
              <img src="/images/logo-main.png" alt="ATS Pro Resume Builder" className="h-14 md:h-[64px] mx-auto md:mx-0 dark:brightness-0 dark:invert" width={64} height={64} loading="lazy" decoding="async" />
              ...
              <div className="mt-5 md:mt-6 flex items-center justify-center md:justify-start gap-2.5 md:gap-3">
                <a href="https://www.facebook.com/share/18EkeUXY8P/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center bg-background/10 text-background/60 transition hover:bg-primary hover:text-primary-foreground">
                ...
                <a href="https://www.instagram.com/atsproresumebuilder?igsh=eGg2M3FmaTF5NGRw" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center bg-background/10 text-background/60 transition hover:bg-primary hover:text-primary-foreground">
                ...
                <a href="https://x.com/Atspro_official" target="_blank" rel="noopener noreferrer" aria-label="Twitter/X" className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center bg-background/10 text-background/60 transition hover:bg-primary hover:text-primary-foreground">
                ...
                <a href="https://www.linkedin.com/company/ats-pro-resume-builder/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center bg-background/10 text-background/60 transition hover:bg-primary hover:text-primary-foreground">
                ...
                <a href="https://www.tiktok.com/@atsproresumebuilder?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center bg-background/10 text-background/60 transition hover:bg-primary hover:text-primary-foreground">
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <img src="/images/logo-main.png" alt="ATS Pro Resume Builder" className="h-16 dark:brightness-0 dark:invert" width={64} height={64} />
            </DialogTitle>
          </DialogHeader>
