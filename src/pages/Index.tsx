    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden font-sans selection:bg-blue-600/10 selection:text-blue-600">
      ...
      <section className="py-32 bg-white relative">
         <div className="container mx-auto px-8 space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
               <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="order-2 lg:order-1 rounded-[3rem] border border-slate-100 shadow-2xl overflow-hidden bg-slate-50">
                  <img src="/images/interview_prep_mockup_v2.png" alt="Interview Preparation" loading="lazy" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
               </motion.div>
               <div className="order-1 lg:order-2 space-y-6 lg:pl-10">
