  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-12 md:py-16 bg-accent/30">
        <div className="mx-auto max-w-3xl px-5 text-center">
          <a href="https://www.trustpilot.com" target="_blank" rel="noopener noreferrer" className="inline-flex flex-col items-center gap-3 group">
          ...
          <div className="grid gap-8 md:gap-10 md:grid-cols-12">
            <div className="md:col-span-5 text-center md:text-left">
              ...
              <div className="mt-5 md:mt-6 flex items-center justify-center md:justify-start gap-2.5 md:gap-3">
                ...
                <a href="https://www.trustpilot.com" target="_blank" rel="noopener noreferrer" aria-label="Trustpilot" className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center rounded-lg bg-background/10 text-background/60 transition hover:bg-[#00b67a] hover:text-white">
