            ...
            <div className="pt-10 md:pt-20 text-center space-y-8 md:space-y-12 overflow-hidden">
               ...
               <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 md:gap-6 pb-8 px-4 md:px-8 -mx-4 md:-mx-8 scrollbar-hide">
                  {[
                     ...
                     <div key={i} className="min-w-[200px] sm:min-w-[260px] md:min-w-[320px] lg:min-w-[380px] snap-center shrink-0 rounded-2xl md:rounded-[2rem] bg-slate-100 aspect-[3/4] shadow-sm border border-slate-200 overflow-hidden group cursor-pointer">
