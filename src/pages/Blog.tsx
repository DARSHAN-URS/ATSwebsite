    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
         ...
         <div className="container mx-auto px-8 relative z-10 text-center space-y-8">
            ...
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-6xl md:text-8xl font-black text-slate-900 dark:text-white tracking-tight">
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSearch(searchInput); }} className="max-w-xl mx-auto flex gap-3 p-2 bg-slate-100 dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-900/5 mt-12">
      ...
      {/* Category Filter */}
      <section className="sticky top-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-100 dark:border-slate-800">
            ...
            {filteredArticles.map((article, i) => (
               ...
               >
                  <Link to={`/blog/${article.slug}`} className="group block h-full">
                     <Card className="rounded-[4rem] border-none bg-slate-50/50 dark:bg-slate-900 shadow-sm hover:shadow-3xl hover:bg-white transition-all overflow-hidden h-full flex flex-col group-hover:-translate-y-4">
                        <div className="p-4">
                           <div className="aspect-[16/10] bg-white dark:bg-slate-800 relative overflow-hidden rounded-[3rem]">
                              <img 
