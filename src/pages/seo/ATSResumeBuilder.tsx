      ...
      <main className="pt-20">
        ...
        <section className="border-y border-slate-100 bg-slate-50/50 py-32">
          <div className="mx-auto max-w-5xl px-8 text-center space-y-12">
            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">{t.ats.linksH2}</h2>
            <div className="flex flex-wrap justify-center gap-4">
              {["/resume-templates", "/resume-builder-for-freshers", "/software-engineer-resume", "/interview-preparation", "/blog"].map((href, i) => (
                <Button key={href} variant="outline" className="h-12 px-6 rounded-xl border-slate-200 font-black uppercase tracking-widest text-[9px] hover:bg-white" asChild><Link to={href}>{t.ats.linkLabels[i]}</Link></Button>
              ))}
            </div>
          </div>
        </section>
