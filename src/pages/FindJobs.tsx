  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      <div className="space-y-4">
        <h1 className="text-5xl font-black text-slate-900 tracking-tighter leading-none uppercase">Jobs</h1>
        <p className="text-slate-500 font-medium">AI-powered job search, recruiter posts & external listings</p>
      </div>
