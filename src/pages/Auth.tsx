        ...
        >
            ...
            <AnimatePresence mode="wait">
              <TabsContent value="login" className="mt-0">
                ...
                >
                  ...
                  <Button type="submit" className="w-full h-12 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-black uppercase tracking-widest text-xs shadow-xl shadow-slate-900/10" disabled={loading}>
          ...
          <div className="space-y-4 pt-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Button 
                variant="outline" 
                className="h-14 rounded-2xl border-slate-200 dark:border-slate-800 font-bold text-sm gap-3 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all shadow-sm"
              ...
              >
                <Apple className="w-5 h-5 fill-slate-900 dark:fill-white" />
                Apple
              </Button>
            </div>
          </div>
