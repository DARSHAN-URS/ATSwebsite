...
export interface SeoTranslations {
  ...
  tpl: {
    ...
    subtitle: string;
    browseH2: string;
    templates: { name: string; desc: string; best: string; image: string }[];
    whatMakesH2: string;
...
const en: SeoTranslations = {
  ...
  tpl: {
    ...
    templates: [
      { name: "Classic ATS", desc: "Traditional single-column layout with clean formatting. The most universally ATS-compatible template, ideal for any industry.", best: "All industries", image: "/images/templates/classic-ats.png" },
      { name: "Modern Professional", desc: "Contemporary typography with slightly larger headings and tighter spacing. Perfect for corporate and tech roles.", best: "Corporate & Tech", image: "/images/templates/modern-pro.png" },
      { name: "Skills-First", desc: "Places skills and keywords before work experience. Ideal for career changers and entry-level candidates looking to highlight competencies.", best: "Career changers", image: "/images/templates/skills-first.png" },
      { name: "Experience-Heavy", desc: "Maximizes space for work experience and achievements. Designed for senior professionals with extensive career histories.", best: "Senior professionals", image: "/images/templates/experience-heavy.png" },
      { name: "Fresher / Entry-Level", desc: "Prioritizes education, academic projects, internships, and skills. Built for recent graduates and first-time job seekers.", best: "Fresh graduates", image: "/images/templates/fresher.png" },
      { name: "Technical / Engineering", desc: "Features grouped skill categories (Languages, Frameworks, Tools, Databases) with structured experience sections for IT and engineering roles.", best: "Engineers & IT", image: "/images/templates/technical.png" },
      { name: "Minimal Compact", desc: "Optimized to fit strong profiles into a single page using reduced margins and tighter line spacing without sacrificing readability.", best: "One-page resumes", image: "/images/templates/minimal.png" },
      { name: "Combination", desc: "Blends chronological and functional formats. Highlights both skills and progressive career growth in a single layout.", best: "Versatile roles", image: "/images/templates/combination.png" },
    ],
...
const ar: SeoTranslations = {
  ...
  tpl: {
    ...
    templates: [
      { name: "كلاسيكي ATS", desc: "تخطيط تقليدي بعمود واحد. الأكثر توافقاً مع ATS.", best: "جميع الصناعات", image: "/images/templates/classic-ats.png" },
      { name: "مهني حديث", desc: "تصميم عصري مثالي للشركات والتقنية.", best: "الشركات والتقنية", image: "/images/templates/modern-pro.png" },
      { name: "المهارات أولاً", desc: "يضع المهارات قبل الخبرة. مثالي لمغيري المهنة.", best: "مغيرو المهنة", image: "/images/templates/skills-first.png" },
      { name: "غني بالخبرة", desc: "يزيد مساحة الخبرة والإنجازات.", best: "كبار المحترفين", image: "/images/templates/experience-heavy.png" },
      { name: "خريج / مبتدئ", desc: "يعطي الأولوية للتعليم والمشاريع والتدريب.", best: "الخريجون الجدد", image: "/images/templates/fresher.png" },
      { name: "تقني / هندسي", desc: "فئات مهارات مجمّعة لأدوار تكنولوجيا المعلومات.", best: "المهندسون وتكنولوجيا المعلومات", image: "/images/templates/technical.png" },
      { name: "مدمج مختصر", desc: "محسّن ليناسب صفحة واحدة.", best: "سيرة ذاتية من صفحة واحدة", image: "/images/templates/minimal.png" },
      { name: "مختلط", desc: "يمزج بين التنسيق الزمني والوظيفي.", best: "أدوار متنوعة", image: "/images/templates/combination.png" },
    ],
...
const es: SeoTranslations = {
  ...
  tpl: {
    ...
    templates: [
      { name: "Clásico ATS", desc: "Diseño tradicional de una columna. El más compatible con ATS.", best: "Todas las industrias", image: "/images/templates/classic-ats.png" },
      { name: "Profesional Moderno", desc: "Tipografía contemporánea para roles corporativos y tecnológicos.", best: "Corporativo y Tecnología", image: "/images/templates/modern-pro.png" },
      { name: "Habilidades Primero", desc: "Coloca las habilidades antes de la experiencia. Ideal para cambio de carrera.", best: "Cambio de carrera", image: "/images/templates/skills-first.png" },
      { name: "Rica en Experiencia", desc: "Maximiza el espacio para experiencia y logros.", best: "Profesionales senior", image: "/images/templates/experience-heavy.png" },
      { name: "Recién Graduado", desc: "Prioriza educación, proyectos y pasantías.", best: "Recién graduados", image: "/images/templates/fresher.png" },
      { name: "Técnico / Ingeniería", desc: "Categorías de habilidades agrupadas para roles de TI.", best: "Ingenieros y TI", image: "/images/templates/technical.png" },
      { name: "Compacto Minimal", desc: "Optimizado para caber en una página.", best: "CVs de una página", image: "/images/templates/minimal.png" },
      { name: "Combinación", desc: "Mezcla formatos cronológico y funcional.", best: "Roles versátiles", image: "/images/templates/combination.png" },
    ],
...
const fr: SeoTranslations = {
  ...
  tpl: {
    ...
    templates: [
      { name: "Classique ATS", desc: "Mise en page traditionnelle à une colonne.", best: "Toutes industries", image: "/images/templates/classic-ats.png" },
      { name: "Professionnel Moderne", desc: "Typographie contemporaine pour le corporate et la tech.", best: "Corporate & Tech", image: "/images/templates/modern-pro.png" },
      { name: "Compétences d'Abord", desc: "Met les compétences en avant.", best: "Reconversion", image: "/images/templates/skills-first.png" },
      { name: "Riche en Expérience", desc: "Maximise l'espace pour l'expérience.", best: "Professionnels seniors", image: "/images/templates/experience-heavy.png" },
      { name: "Débutant / Junior", desc: "Priorise l'éducation et les projets.", best: "Jeunes diplômés", image: "/images/templates/fresher.png" },
      { name: "Technique / Ingénierie", desc: "Catégories de compétences groupées.", best: "Ingenieurs & IT", image: "/images/templates/technical.png" },
      { name: "Compact Minimal", desc: "Optimisé pour une seule page.", best: "CV d'une page", image: "/images/templates/minimal.png" },
      { name: "Combinaison", desc: "Mélange chronologique et fonctionnel.", best: "Rôles polyvalents", image: "/images/templates/combination.png" },
    ],
