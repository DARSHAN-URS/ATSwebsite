  ...
  return (
    <>
      <div className="p-4 pb-2 flex items-center justify-center">
        <img alt="ATS Pro Resume Builder" className="h-32 w-auto object-contain dark:brightness-0 dark:invert" width={128} height={128} decoding="async" src="/images/logo-main.png" />
      </div>
