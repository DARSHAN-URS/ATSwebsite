  ...
  return (
    <>
      <div className="p-4 pb-2 flex items-center justify-center">
        <img alt="ATS Pro Resume Builder" className="h-32 w-auto object-contain" width={128} height={128} decoding="async" src="/lovable-uploads/5915efbe-e4c7-42be-ba1b-f3eb8a705409.png" />
      </div>
