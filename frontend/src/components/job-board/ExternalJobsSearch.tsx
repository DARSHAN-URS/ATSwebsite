      ...
      {!searching && jobs.length === 0 && (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-lg font-semibold">Search external jobs</h3>
            <p className="text-sm text-muted-foreground mt-1">Select a resume and search to find AI-matched job listings</p>
          </CardContent>
        </Card>
      )}
    </div>
